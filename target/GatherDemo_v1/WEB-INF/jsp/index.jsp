...
<title>Bootstrap后台管理系统模版Ace下载</title>
		...
		<script src="<%=$root %>/js/index/menu.js"></script>
		<script src="<%=$root %>/js/index/sidebar-menu.js"></script>
		<script src="<%=$root %>/js/index/bootstrap-tab.js"></script>
	</head>
	...
	<body>
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='<%=$root %>/assets/js/jquery-2.0.3.min.js'>"+"<"+"script>");
		</script>

		<script type="text/javascript">
			if("ontouchend" in document) document.write("<script src='<%=$root %>/assets/js/jquery.mobile.custom.min.js'>"+"<"+"script>");
		</script>
